...
$sql= "update tablebooking set Status=:status,Remark=:remark where ID=:eid";
...
$sql="SELECT tablebooking.BookingID,tablebooking.Name,tablebooking.MobileNumber,tablebooking.Email,tablebooking.EventDate,tablebooking.EventStartingtime,tablebooking.EventEndingtime,tablebooking.VenueAddress,tablebooking.EventType,tablebooking.AdditionalInformation,tablebooking.BookingDate,tablebooking.Remark,tablebooking.Status,tablebooking.UpdationDate,tableservice.ServiceName,tableservice.SerDes,tableservice.ServicePrice from tablebooking join tableservice on tablebooking.ServiceID=tableservice.ID  where tablebooking.ID=:eid";
$query = $dbh -> prepare($sql);
$query-> bindParam(':eid', $eid, PDO::PARAM_STR);
$query->execute();
