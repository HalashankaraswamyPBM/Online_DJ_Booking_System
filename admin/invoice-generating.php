...
$sql="SELECT tablebooking.BookingID,tablebooking.Name,tablebooking.MobileNumber,tablebooking.Email,tablebooking.EventDate,tablebooking.EventStartingtime,tablebooking.EventEndingtime,tablebooking.VenueAddress,tablebooking.EventType,tablebooking.AdditionalInformation,tablebooking.BookingDate,tablebooking.Remark,tablebooking.Status,tablebooking.UpdationDate,tableservice.ServiceName,tableservice.SerDes,tableservice.ServicePrice from tablebooking join tableservice on tablebooking.ServiceID=tableservice.ID  where tablebooking.ID=:invid";
